...
class PromotionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $promotions = $em->getRepository('AdminBundle:Promotion')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AdminBundle\Form\PromotionType', $promotion);
    ...
    {
        $deleteForm = $this->createDeleteForm($promotion);
        $editForm = $this->createForm('AdminBundle\Form\PromotionType', $promotion);
